...
public class WifiAdmin {
    private static WifiAdmin ourInstance;

    public static WifiAdmin getInstance() {
        if(null == ourInstance) {
            throw new RuntimeException("WifiAdmin not instanced.");
        }
        return ourInstance;
    }

    public static void init(Context context) {
        ourInstance = new WifiAdmin(context);
    }
    ...
    public void startScan1(Context context) {
        mWifiManager.startScan();
        //得到扫描结果
