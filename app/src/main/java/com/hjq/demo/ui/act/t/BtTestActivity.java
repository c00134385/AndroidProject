...
//设置Adapter
        ...
        btList.addItemDecoration(new MyRecyclerViewDivider(this, LinearLayoutManager.HORIZONTAL,2, ContextCompat.getColor(this, R.color.colorAccent)));
        //设置分隔线
...
//                adapter.notifyDataSetChanged();//更新
    ...
    class BtRecyclerAdapter extends RecyclerView.Adapter<BtRecyclerAdapter.BtViewHolder> {
